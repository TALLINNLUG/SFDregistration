...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["age"])) {
    $ageErr = "Õppetund valik on vajalik / Требуется указать возраст / Age is required";
  } else {
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  <span class="error">* <?php echo $tutorialErr;?></span><br />
...
ne joonistamine / Цифровая живопись / Digital painting ">Digitaalne joonistamine / Цифровая живопись / Digital painting<br />
  ...
  <span class="error">* <?php echo $computerErr;?></span><br />
...
ет / no
  ...
  Palun sisesta <b>ANIMATSIOON</b> eespool. / Пожалуйста, введите <b>ANIMATSIOON</b> выше. / Please enter <b>ANIMATSIOON</b> above. <br
 />
  <br><br>
...
if (isset($_POST['formsubmit'])){
 ...
 if (strtolower($_POST['code']) != 'animatsioon' ) {die('vale koodi / неверный код доступа / Wrong access code');}
   ...
   $myemail  = "benson.muite@eestikohtuma.info";
